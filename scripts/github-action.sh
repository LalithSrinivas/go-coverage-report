...
TARGET_BRANCH=${TARGET_BRANCH:-lalith/ut-coverage-base}
...
LAST_SUCCESSFUL_RUN_ID=$(gh run list --branch="lalith/ut-coverage-base" --workflow="$GITHUB_BASELINE_WORKFLOW" --event=push --json=databaseId --limit=1 -q '.[] | .databaseId')
